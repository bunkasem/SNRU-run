...
public class Exercise extends AppCompatActivity {
    ...
    private String[] questionStrings,choice1Strings,choice2Strings,choice3Strings,choice4Strings, answerStrings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SynQuestoin synQuestoin = new SynQuestoin();
        synQuestoin.execute();
    ...
    private boolean checkRadio() {
        ...
        if (choice1RadioButton.isChecked()) {
            ...
            myResult = false; // NonCheck
        }

        return myResult;
    }   // CheckRadio

    public class SynQuestoin extends AsyncTask<Void, Void, String> {
