...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private double[] buildLatDoubles = {17.1945,17.19188081,17.18847796,17.19089686};
    private double[] buildLngDoubles = {104.09,104.09524441,104.09335613,104.08887148};
    private int[] buiInts = {R.drawable.build1, R.drawable.build2, R.drawable.build3, R.drawable.build4};
    ...
    public class Synlocation extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            for (int i=0;i<buildLatDoubles.length;i++) {
                ...
                .icon(BitmapDescriptorFactory.fromResource(buiInts[i])));
    ...
    private void updateLocation() {
        ...
        //Check Distance
        double myDistane = distance(myLatADouble, myLngADouble,
                buildLatDoubles[0], buildLngDoubles[0]);
        Log.d("19May", "myDistance ==" + myDistane);
        if (myDistane < 50) {
